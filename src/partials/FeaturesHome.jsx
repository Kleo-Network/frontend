...
function FeaturesHome() {
  ...
  return (
    <section id="third" className="w-full flex flex-col">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      ...
                      Enable them to enhance your experience but not at the cost
                      of privacy.
                      <br />
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Facebook & Google together made approximately $137 per
                      user last year by making you a product. It's time to take
                      back control.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Send your data pocket to work, we have created a
                      marketplace for you to browse the internet from other
                      person's perspective. You can now earn rent from your data
                      pocket, without sacrificing absolute privacy.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                    <svg
