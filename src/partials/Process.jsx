    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16 border-t border-gray-200">
          ...
          <h3 className='className="relative text-center font-semibold text-xl mb-3 -mt-2'>Takes under 5 minutes to get started! </h3>
          {/* Items */}
          <div className="relative max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-4 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cookie Manager</h4>
              {/* <p className="text-gray-600 text-center">Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat cupidatat.</p> */}
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Intent of Use</h4>
              {/* <p className="text-gray-600 text-center">Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat cupidatat.</p> */}
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Embed Code</h4>
              {/* <p className="text-gray-600 text-center">Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat cupidatat.</p> */}
            </div>
