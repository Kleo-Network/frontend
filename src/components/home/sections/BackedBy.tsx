...
export function BackedBy() {
  return (
    <div className="self-stretch py-12 lg:py-20 bg-violet-800 justify-center items-start flex z-10">
      <div className="px-8 flex-col justify-center items-center gap-8 flex">
        <div className="self-stretch text-center text-gray-100 text-3xl font-semibold">
          Backed by
        </div>
        <div className="self-stretch justify-center items-start gap-16 flex flex-row flex-wrap">
          {BackedByList.map(({ name, link }) => (
            <div className="flex flex-row gap-2 items-center">
              ...
              />
              <span className="text-gray-200 text-xl lg:text-2xl font-medium">
                {name}
              </span>
            </div>
          ))}
