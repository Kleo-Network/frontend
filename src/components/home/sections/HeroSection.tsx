...
export function HeroSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-center self-stretch font-inter">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 self-stretch lg:px-32 px-4 py-40">
        <div className="flex flex-col items-center gap-8 px-8">
          <div className="flex flex-col justify-center items-start gap-12">
            <div className="flex flex-col items-start gap-6 self-stretch relative">
              ...
              <div className="flex flex-col self-end gap-1 absolute translate-x-[150%] bottom-0">
                <YellowArrow className="h-7 w-7 fill-yellow-400 absolute -translate-x-full -translate-y-full " />
                <div className="px-2 py-1 bg-yellow-400 rounded-sm shadow-sm text-sm text-white font-medium">
                  <span>Connect</span>
                </div>
              </div>
        ...
        <div className="flex">
          <div className="relative">
            <div className="flex flex-col self-end gap-1 absolute -translate-x-[110%] bottom-0 translate-y-[200%]">
