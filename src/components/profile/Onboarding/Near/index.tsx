...
import { ReactComponent as MetaMaskLogo } from '../../../../assets/images/sender.svg'
...
const contractId = 'dev-1699533302895-87934527609853'
...
export default function Onboarding({ closeModal }: OnboardingProps) {
  ...
  const [accessKey, setKey] = useState<any>(null)
    ...
    try {
      if (accessKey.secretKey) {
        ...
        fetchData(AUTH_API, {
          ...
          body: JSON.stringify({
            signature:
              '0x3bf25f65ab346164199a6caf9df788b333b4a852d25b785e6f022eaf34d8058e41c03cbd434255b352d104db183efbad02c148af0152f74777debf04337d33d51c',
            publicAddress: '0x57e7b7f1c1a8782ac9d3c4d730051bd60068aeee',
            chain: 'ethereum'
          }),
          onSuccessfulFetch(data) {
  ...
  const signin = async () => {
    try {
      ...
      const res = await (window as any).near.requestSignIn({
        contractId: 'dev-1699533302895-87934527609853',
        ...
        <>
          ...
          <div className="flex flex-row items-start gap-4 p-6">
            <div className="relative">
              ...
              <MetaMaskLogo className="w-14 h-14 fill-[#FFE6D5]" />
            </div>
            {!isWalletConnected ? (
              <div className="flex flex-col items-start justify-center">
                <span className="text-gray-900 text-base font-medium">
                ...
                <span className="text-gray-400 text-sm font-regular">
                  Connect with your Sender wallet to get started
                </span>
                <div className="flex flex-row justify-start items-center mt-4 text-sm font-medium">
                  <button
                    className="px-4 py-3 bg-primary text-white rounded-lg shadow mr-1"
