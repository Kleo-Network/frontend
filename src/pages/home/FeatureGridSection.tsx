        ...
        <div className="flex flex-col gap-[60px] items-center">
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            <div className="flex flex-col gap-1 items-start w-full">
              ...
              <p className="font-roboto font-normal text-[11px]">
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            {/* Text */}
            <div className="flex flex-col gap-1 items-start w-full">
              <div className="font-semibold text-2xl">Earn Rewards</div>
              <p className="font-roboto font-normal text-[11px]">
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            {/* Text */}
            <div className="flex flex-col gap-1 items-start w-full">
              <div className="font-semibold text-2xl">Kleo SDK</div>
              <p className="font-roboto font-normal text-[11px]">
              ...
              <a
                href="#"
                className="font-medium text-sm text-white bg-primary-500 hover:bg-primary-600 px-[14px] py-[8px] rounded-[4px] mt-[12px]"
              >
                Learn More
              </a>
            </div>
